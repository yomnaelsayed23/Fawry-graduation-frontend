...
@Component({
  ...
  standalone: true,
  imports: [SidebarComponent, MerchantsComponent, MerchantSidebarComponent, MerchantProductsComponent, CreateCouponModelComponent, CouponsComponent, CreateProductComponent],
